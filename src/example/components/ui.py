...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.output_trans.setGeometry(QRect(210, 160, 57, 14))
        ...
        self.label_eval.setGeometry(QRect(50, 160, 131, 31))
        ...
        self.label_trans.setGeometry(QRect(260, 160, 131, 31))
        ...
        self.label_tree.setAlignment(Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_eval.setText(QCoreApplication.translate("MainWindow", u" TextLabel", None))
        self.label_trans.setText(QCoreApplication.translate("MainWindow", u" TextLabel", None))
        self.label_tree.setText(QCoreApplication.translate("MainWindow", u"TextLabel", None))
    # retranslateUi
